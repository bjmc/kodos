...
class ReferenceBA(QMainWindow):
    def __init__(self,parent = None,name = None,fl = 0):
        ...
        self.fileNewAction.setIconSet(QIcon(self.image1))
        self.fileOpenAction = QAction(self,"fileOpenAction")
        self.fileOpenAction.setIconSet(QIcon(self.image2))
        self.fileSaveAction = QAction(self,"fileSaveAction")
        self.fileSaveAction.setIconSet(QIcon(self.image3))
        self.fileSaveAsAction = QAction(self,"fileSaveAsAction")
        self.filePrintAction = QAction(self,"filePrintAction")
        self.filePrintAction.setIconSet(QIcon(self.image4))
        self.fileExitAction = QAction(self,"fileExitAction")
        self.fileExitAction.setIconSet(QIcon(self.image5))
        self.editUndoAction = QAction(self,"editUndoAction")
        self.editUndoAction.setIconSet(QIcon(self.image6))
        self.editRedoAction = QAction(self,"editRedoAction")
        self.editRedoAction.setIconSet(QIcon(self.image7))
        self.editCutAction = QAction(self,"editCutAction")
        self.editCutAction.setIconSet(QIcon(self.image8))
        self.editCopyAction = QAction(self,"editCopyAction")
        self.editCopyAction.setIconSet(QIcon(self.image9))
        self.editPasteAction = QAction(self,"editPasteAction")
        self.editPasteAction.setIconSet(QIcon(self.image10))
        self.editFindAction = QAction(self,"editFindAction")
        self.editFindAction.setIconSet(QIcon(self.image11))
        self.helpContentsAction = QAction(self,"helpContentsAction")
        self.helpIndexAction = QAction(self,"helpIndexAction")
        self.helpAboutAction = QAction(self,"helpAboutAction")
        self.helpAction = QAction(self,"helpAction")
        self.helpAction.setIconSet(QIcon(self.image12))
